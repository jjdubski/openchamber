...
export const dict: Record<I18nKey, string> = {
  ...
  'multirun.fusion.title': '运行 fusion',
  'multirun.fusion.description': '将选中的 multi-run 输出合并为一个更强的答案。',
  ...
  'multirun.fusion.actions.start': '开始 fusion',
  'multirun.fusion.actions.starting': '正在开始...',
  'multirun.fusion.toast.noOutputs': '未找到可用于 fusion 的助手输出。',
  'multirun.fusion.toast.failed': '启动 fusion 失败。',
